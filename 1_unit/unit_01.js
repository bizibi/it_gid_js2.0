...
document.querySelector(".four").innerHTML +=
  "<h4>Произвольный текст</h4> <p>Произвольный текст</p>";
...
let y1 = 6;
let y2 = 3;
let resultDevide = document.querySelector(".out-15");
resultDevide.innerHTML = y1 / y2;
...
let x1 = "Hello";
let x2 = 5;
resultCast = document.querySelector(".out-16");
resultCast.innerHTML = x1 + x2;
